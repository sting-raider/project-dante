...
import type { MerchantAnalytics } from "@/lib/rights-ui";
          ...
          <>
            ...
            <aside className="mt-16 rounded-md border border-warning/50 bg-warning/[0.06] p-5">
              ...
              <p className="mt-2 max-w-prose text-sm leading-relaxed text-ink-soft">
                ...
                real: Razorpay Test Mode orders, webhooks and refunds execute
                through genuine signed API traffic when keys are configured;
                otherwise the sandbox adapter says so on every surface.
              </p>
            </aside>
          </>
        )}
